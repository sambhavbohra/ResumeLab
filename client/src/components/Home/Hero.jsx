                        ...
                        <div className="pb-20">
                                ...
                                <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
                                        ...
                                        <div className="flex gap-2">
                                                <Link to='/register' className="hidden md:block px-6 py-2 active:scale-95 transition-all rounded-full text-white bg-[var(--textdark)] hover:bg-[var(--textlight)]" hidden={user}>
                                                        Get started
                                                </Link>
                                                <Link to='/login' className="hidden md:block px-6 py-2 border border-[var(--textdark)] active:scale-95 transition-all rounded-full text-slate-700 hover:bg-[var(--gradientend)] hover:text-[var(--textdark)]" hidden={user}>
                                                        Login
                                                </Link>
                                                ...
                                                <div>
                                                        <div className="flex ">
                                                                {Array(5).fill(0).map((_, i) => (
                                                                        <svg key={i} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-star text-transparent fill-[#c01219]" aria-hidden="true"><path d="M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z"></path></svg>
                                                                ))}
                                                        </div>
                                                        <p className="text-sm text-black">
                                                                Used by college students and freelancers
                                                        </p>
                                                </div>
                                        </div>
